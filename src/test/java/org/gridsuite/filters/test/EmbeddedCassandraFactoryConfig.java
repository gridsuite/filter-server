 ...
 */
package org.gridsuite.filters.test;
...
public class EmbeddedCassandraFactoryConfig {
    ...
    CassandraConnection cassandraConnection(Cassandra cassandra) {
        ...
        CqlDataSet.ofClasspaths("create_keyspace.cql", "filters.cql").forEachStatement(cassandraConnection::execute);
    ...
    CassandraFactory embeddedCassandraFactory() throws UnknownHostException {
        ...
        cassandraFactory.setTimeout(Duration.ofSeconds(900)); //default is 90, we are getting timeouts on GH filters
