 ...
 */
package org.gridsuite.filters.server.configs;
...
@EnableCassandraRepositories(basePackageClasses = {ScriptFilterRepository.class})
public class CassandraConfig extends AbstractCassandraConfiguration {

    static final String KEYSPACE_NAME = "filters";
