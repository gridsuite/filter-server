...
public class VscConverterStationFilter extends AbstractInjectionFilter {
    ...
    public VscConverterStationFilter(String equipmentID, String equipmentName, String substationName, SortedSet<String> countries, NumericalFilter nominalVoltage) {
