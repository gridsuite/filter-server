        ...
        switch (filter.getType()) {
            ...
            case TWO_WINDINGS_TRANSFORMER:
                ...
                if (twoWindingsTransformerFilter.getEquipmentID() != null) {
                    template.add("equipmentId", twoWindingsTransformerFilter.getEquipmentID());
                }
                if (twoWindingsTransformerFilter.getEquipmentName() != null) {
                    template.add("equipmentName", twoWindingsTransformerFilter.getEquipmentName());
                }
                ...
                if (!StringUtils.isEmpty(twoWindingsTransformerFilter.getSubstationName())) {
                    template.add("substationName", twoWindingsTransformerFilter.getSubstationName());
                }
                break;
            ...
            case THREE_WINDINGS_TRANSFORMER:
                ...
                if (threeWindingsTransformerFilter.getEquipmentID() != null) {
                    template.add("equipmentId", threeWindingsTransformerFilter.getEquipmentID());
                }
                if (threeWindingsTransformerFilter.getEquipmentName() != null) {
                    template.add("equipmentName", threeWindingsTransformerFilter.getEquipmentName());
                }
                ...
                if (!StringUtils.isEmpty(threeWindingsTransformerFilter.getSubstationName())) {
                    template.add("substationName", threeWindingsTransformerFilter.getSubstationName());
                }
                break;
            ...
            case VSC_CONVERTER_STATION:
                ...
                if (injectionFilter.getEquipmentID() != null) {
                    template.add("equipmentId", injectionFilter.getEquipmentID());
                }
                if (injectionFilter.getEquipmentName() != null) {
                    template.add("equipmentName", injectionFilter.getEquipmentName());
                }
                ...
                if (!StringUtils.isEmpty(injectionFilter.getSubstationName())) {
                    template.add("substationName", injectionFilter.getSubstationName());
                }
                break;
            ...
            case HVDC_LINE:
                ...
                if (hvdcLineFilter.getEquipmentID() != null) {
                    template.add("equipmentId", hvdcLineFilter.getEquipmentID());
                }
                if (hvdcLineFilter.getEquipmentName() != null) {
                    template.add("equipmentName", hvdcLineFilter.getEquipmentName());
                }
                if (!CollectionUtils.isEmpty(hvdcLineFilter.getCountries1())) {
                    template.add("countries1", hvdcLineFilter.getCountries1().stream().collect(joining("','", "['", "']")));
                }
                if (!CollectionUtils.isEmpty(hvdcLineFilter.getCountries2())) {
                    template.add("countries2", hvdcLineFilter.getCountries2().stream().collect(joining("','", "['", "']")));
                }
                ...
                if (!StringUtils.isEmpty(hvdcLineFilter.getSubstationName1())) {
                    template.add("substationName1", hvdcLineFilter.getSubstationName1());
                }
                if (!StringUtils.isEmpty(hvdcLineFilter.getSubstationName2())) {
                    template.add("substationName2", hvdcLineFilter.getSubstationName2());
                }
                break;
